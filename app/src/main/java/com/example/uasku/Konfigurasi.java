package com.example.uasku;

public class Konfigurasi {
    public static final String URL_ADD="http://10.148.56.226/api/tambah.php";
    public static final String URL_GET_ALL="http://10.148.56.226/api/tampil.php";
